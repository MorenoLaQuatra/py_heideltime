...
def exec_java_heideltime(filename, path, language, document_type, document_creation_time, date_granularity, config_props_path):
    ...
    if match == [] and document_creation_time != 'yyyy-mm-dd':
        ...
        if document_creation_time == 'yyyy-mm-dd':
            ...
            java_command = "java -Dfile.encoding=UTF-8 -jar " + path + "/Heideltime/tilse/de.unihd.dbs.heideltime.standalone.jar " + filename + " -l " + language.upper() + " -t document_type " + " -c " + config_props_path
        else:
            '''
            ...
            '''
            java_command = "java -Dfile.encoding=UTF-8 -jar " + path + "/Heideltime/tilse/de.unihd.dbs.heideltime.standalone.jar " + filename + " -l " + language.upper() + " -dct " + str(document_creation_time) + " -t document_type " + " -c " + config_props_path
